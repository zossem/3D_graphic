...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	WxSB_TranslationX->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxST_TranslationX->SetMinSize(this->FromDIP(wxSize(30, -1)));
	...
	WxSB_TranslationY->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxSB_TranslationZ->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxSB_RotateX->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxSB_RotateY->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxSB_RotateZ->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxSB_ScaleX->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxSB_ScaleY->SetMinSize(this->FromDIP(wxSize(100, -1)));
	...
	WxSB_ScaleZ->SetMinSize(this->FromDIP(wxSize(100, -1)));
